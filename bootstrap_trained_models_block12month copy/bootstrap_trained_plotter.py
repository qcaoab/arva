...
ax.plot(-357.66, 40, marker = "*", color="blue", mew=2, fillstyle='none', markersize=10, linewidth=2, label = "Bengen (1994)Strategy")
...
ax.annotate("Bengen (1994) \nStrategy", 
                    ...
                    color="blue",
                    xy=(-357.66, 40),
                    xytext=(0.55,0.3),    # fraction, fraction
                    textcoords='figure fraction',
...
# plt.savefig('/home/marcchen/Documents/testing_pyt_decum/researchcode/bootstrap_trained_models_block12month/mar14_ef_trainedon_block12month_bootandsim.pdf',format="pdf")
