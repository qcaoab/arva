...
factor2_df = read_log_file("/home/marcchen/Documents/constrain_factor/researchcode/log_output_TEST2_EFs/2_factor_constrain_indiv_log_08-09-2023.txt")

factor2_df.drop(factor2_df[factor2_df['kappa'] == 1.2].index, inplace=True)
factor2_df.drop(factor2_df[factor2_df['kappa'] == 25].index, inplace=True)

#simulated test
basic_df = read_log_file("/home/marcchen/Documents/constrain_factor/researchcode/log_output_TEST2_EFs/2basic_NN_log_08-09-2023.txt")

basic_df.drop(basic_df[basic_df['kappa'] == 1.2].index, inplace=True)
basic_df.drop(basic_df[basic_df['kappa'] == 25].index, inplace=True)
...
ax.annotate("Constant: \nBasic 2 Asset", 
                    ...
                    xytext=(0.41,0.35),    # fraction, fraction
                    textcoords='figure fraction',
                    horizontalalignment='center',
                    verticalalignment='bottom')
...
ax.annotate("Constant: \n2 Factor Basket", 
                    ...
                    color="darkorange",
                    xy=(bengen_x, bengen_y),
                    xytext=(0.28,0.45),    # fraction, fraction
                    textcoords='figure fraction',
                    horizontalalignment='center',
                    verticalalignment='bottom')
...
plt.savefig('/home/marcchen/Documents/constrain_factor/researchcode/formatted_output/factor_ef_comp_DS2_train.pdf',format="pdf")
