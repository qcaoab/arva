...
factor2_df = read_log_file("/home/marcchen/Documents/constrain_factor/researchcode/log_output_TEST2_EFs/2_factor_constrain_indiv_log_TEST_OOD_08-12-2023.txt")

#simulated test
basic_df = read_log_file("/home/marcchen/Documents/constrain_factor/researchcode/log_output_TEST2_EFs/2basic_NN_log_TEST_OOD_08-12-2023.txt")

basic_df.drop(basic_df[basic_df['kappa'] == 5].index, inplace=True)
...
ax.annotate("NN: 2 Factor, \nlimit_type=indiv", 
            ...
            xytext=(0.7,0.75),    # fraction, fraction
...
ax.annotate('', 
            fontweight="medium",
            fontsize=14,
            xy=(factor2_df["cvar_05"][label_idx]+3,factor2_df["qsum_avg"][label_idx]+0.2),
            xytext=(0.70,0.75),    # fraction, fraction
            textcoords='figure fraction',
...
ax.annotate('', 
            fontweight="medium",
            fontsize=14,
            xy=(basic_df["cvar_05"][label_idx]+3,basic_df["qsum_avg"][label_idx]+0.3),
            xytext=(0.35,0.8),    # fraction, fraction
            textcoords='figure fraction',
...
ax.annotate("Constant: \n2 Factor Basket", 
                    ...
                    color="darkorange",
                    xy=(bengen_x, bengen_y),
                    xytext=(0.27,0.45),    # fraction, fraction
                    textcoords='figure fraction',
                    horizontalalignment='center',
                    verticalalignment='bottom')
...
plt.savefig('/home/marcchen/Documents/constrain_factor/researchcode/formatted_output/factor_ef_comp_DS2_TEST.pdf',format="pdf")
