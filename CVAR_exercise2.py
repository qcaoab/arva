...
# -----------------------------------------------------------------------------------------------
params["obj_fun"] = "meancvarLIKE_constant_wstar"
...
output_parameters["output_results_Excel"] = False      #Output results summary to Excel
...
output_parameters["output_W_T_histogram_and_cdf"] = False        #output Excel sheet with numerical histogram and CDF of terminal wealth (train, test and benchmark)
...
# PERCENTILES:
output_parameters["output_Pctiles_Excel"] = False #If True, outputs Excel spreadsheet with NN pctiles of proportions in each asset and wealth over time
...
output_parameters["save_Figures_FunctionHeatmaps"] = False #if True, plot and save the function heatmap figures
output_parameters["output_FunctionHeatmaps_Excel"] = False  # If TRUE, output the heatmap grid data to Excel

output_parameters["save_Figures_DataHeatmaps"] = False   #if True, plot and save the data heatmap figures
...
# def NN_solver(wstar):
    ...
    print("chosen wstar from list: ", params_TRAIN["obj_fun_constant_wstar"])
