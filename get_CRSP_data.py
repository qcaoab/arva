...
first_year = 1926
last_year = 2022 # update for future years (start of 2019 is end of 2018)
...
dfT = pd.read_csv('treasury_2021.csv', index_col=0)
...
dfS = pd.read_csv('stock_indexes_2021.csv', index_col=0)
...
if writeout:
    ...
    dfw.to_csv('real_indexes_2021.csv', index=False)