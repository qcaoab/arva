...
# Portfolio optimization problem using NN to model dual control for decumulation problem 
...
params["asset_basket_id"] = "B10_and_VWD"     #"basic_ForsythLi"    #Pre-defined basket of underlying candidate assets - see fun_Data_assets_basket.py
...
for i,tracing_param in enumerate(tracing_parameters_to_run): #Loop over tracing_params
    ...
    # query NN to get plot data:-----------------------
    
    n = 5
    
    g_prev = torch.linspace(900, 1100, 1000, device = params["device"])
